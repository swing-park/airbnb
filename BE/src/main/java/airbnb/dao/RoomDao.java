...
public class RoomDao {
    ...
    public List<Room> findByCityIdAndSchedule(Long cityId, Schedule schedule) {
        String sql = "SELECT a.id, price, title, description, people, oneroom, bed, bath, hair_dryer, air_conditioner, wifi, clean_tax, latitude, longitude FROM room AS a left join reservation AS b ON a.id = b.room_id " +
